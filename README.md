...
<!---![Map of fires by incident type](./assets/tableau/Tableau_fire_map.png)--->
...
3. [`Smoke exposure estimates from Harvard Datavese`](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/CTWGWE), 2000-2019: preprocessed by Jason Vargo to summarize NOAA Hazard-Mapping System satellite images into geocoded smoke-coverage classes (low, med, high).
...
![](./assets/tableau/fire_smoke_OT.png)
...
![](./assets/tableau/fire_acreage_OT.png)

* There is a strong seasonal pattern from the hottest summer to fall months:

![](./assets/tableau/fire_ignition_count.png) ![](./assets/tableau/fire_ignition_count_by_mo.png)
...
* [`Cleaning` notebook](https://github.com/rileydr/AirQuality-USWest/blob/main/code/hm_notebooks/1_cleaning_smoke.ipynb)
* [`Merging` notebook](https://github.com/rileydr/AirQuality-USWest/blob/main/code/hm_notebooks/2_merging_smoke_fires.ipynb)
* [`EDA`](./code/va-EDA.ipynb)
<!---* [`Scraping` notebook]()--->
* [`Modeling` notebook](https://github.com/rileydr/AirQuality-USWest/blob/main/code/hm_notebooks/5_modeling_feature_eng.ipynb)

* [`Slides`](https://docs.google.com/presentation/d/10I3ZuSoi1APt5GTSe4lJPC51fLsKmMWfKAVmRrd-5NY/edit#slide=id.p)
* [`Tableau interactive demo`](https://public.tableau.com/profile/riley.robertson#!/vizhome/wildfires_v2/FIRESANDSMOKEOverTime)
<!---
